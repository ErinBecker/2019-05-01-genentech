...
venue: "Genentech Software Carpentry Python workshop"        # brief name of host site without address (e.g., "Euphoric State University")
address: "South Campus Building 42 - Room 42-1D (Day 1 only)"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
enddate: 2019-05-02        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Thomas Balinger", "Erin Becker"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Nolan Nichols"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:   https://pad.carpentries.org/2019-05-01-genentech          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
---
...
<p> Please note that this workshop will be held in different locations for each of the two days. The link above
  shows directions for the first day's location. The complete location information is:</p>
...
| 9:15 | Thomas | [Analyzing Patient Data with Python](http://swcarpentry.github.io/python-novice-inflammation/01-numpy/index.html) cont. |
| 10:00 | Thomas | [Repeating Actions with Loops](http://swcarpentry.github.io/python-novice-inflammation/02-loop/index.html) | 
| 10:30 | Thomas | [Storing Multiple Values in Lists](http://swcarpentry.github.io/python-novice-inflammation/03-lists/index.html) | 
| 10:45 | Coffee Break | | 
...
| 3:15 | Coffee Break | | 
| 3:30 | Thomas | [Command-Line Programs](http://swcarpentry.github.io/python-novice-inflammation/10-cmdline/index.html) |
| 4:50 | Thomas | Wrap-up and surveys |
| 5:00 | end ||
